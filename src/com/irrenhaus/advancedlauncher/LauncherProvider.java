...
import com.irrenhaus.advancedlauncher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.irrenhaus.advancedlauncher.settings";
    
    static final String EXTRA_BIND_SOURCES = "com.irrenhaus.advancedlauncher.settings.bindsources";
    static final String EXTRA_BIND_TARGETS = "com.irrenhaus.advancedlauncher.settings.bindtargets";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        DatabaseHelper(Context context) {
            ...
            mContext = context;
            mAppWidgetHost = new AppWidgetHost(context, AdvancedLauncher.APPWIDGET_HOST_ID);
        }
