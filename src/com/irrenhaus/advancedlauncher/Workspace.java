...
public class Workspace extends ViewGroup implements DropTarget, DragSource, DragScroller {
    ...
    private AdvancedLauncher mLauncher;
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDefaultScreen = com.irrenhaus.advancedlauncher.extended.data.ExtendedSettings.Home_DefaultScreen(context);
        mHomeScreens = com.irrenhaus.advancedlauncher.extended.data.ExtendedSettings.Home_HomeScreens(context);

        AdvancedLauncher.DEFAULT_SCREN = mDefaultScreen;
        AdvancedLauncher.SCREEN_COUNT = mHomeScreens;
    ...
    private void initWorkspace() {
        ...
        AdvancedLauncher.setScreen(mCurrentScreen);
    ...
    public void onDropCompleted(View target, boolean success) {
        if (success){
            if (target != this && mDragInfo != null) {
                ...
                AdvancedLauncher.getModel().removeDesktopItem((ItemInfo) tag);
            }
        } else {
            if (mDragInfo != null) {
                final CellLayout cellLayout = (CellLayout) getChildAt(mDragInfo.screen);
     ...
     * {@link AdvancedLauncher} to accept or block dpad-initiated long-presses.
     */
            ...
            for (int j = 0; j < childCount; j++) {
                ...
                if (tag instanceof ApplicationInfo) {
                    ...
                    if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPLICATION &&
                        ...
                        final Drawable icon = AdvancedLauncher.getModel().getApplicationInfoIcon(
