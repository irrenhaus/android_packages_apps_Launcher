 ...
 */
public final class AdvancedLauncher extends Activity implements View.OnClickListener, OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(com.irrenhaus.advancedlauncher.extended.data.ExtendedSettings.Sensor_Enabled(this)==0) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final Intent extendedsettings = new Intent(AdvancedLauncher.this, ExtendedSettings.class);
        ...
        menu.add(0, MENU_SUBMENU, 0, "Create Submenu").setIcon(android.R.drawable.ic_menu_preferences)
        		.setAlphabeticShortcut('S').setOnMenuItemClickListener(new OnMenuItemClickListener() {
					public boolean onMenuItemClick(MenuItem item) {
						if(item.getItemId() == MENU_SUBMENU)
						{
							AlertDialog.Builder builder = new AlertDialog.Builder(AdvancedLauncher.this);
							
							LinearLayout layout = new LinearLayout(AdvancedLauncher.this);
							layout.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
							
							final EditText edit = new EditText(AdvancedLauncher.this);
							
							edit.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
							
							layout.addView(edit);
							
							builder.setTitle("Create SubMenu");
							builder.setView(layout);
							
							builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int which) {
									SubMenuDBHelper hlp = new SubMenuDBHelper(AdvancedLauncher.this, false);
				                	...
				                	info.id = -1;
				                	info.icon = AdvancedLauncher.this.getResources().getDrawable(R.drawable.ic_launcher_folder);
				                	
				                	Intent launchIntent = new Intent(Intent.ACTION_MAIN);
				                    launchIntent.setClass(AdvancedLauncher.this, SubMenu.class);
				                    launchIntent.putExtra("com.irrenhaus.advancedlauncher.Extended.SubMenu", info.title);
				                	
				                	info.intent = launchIntent;
				                	
				                	info.isSubMenu = true;
									
									AdvancedLauncher.getModel().addApplicationInfo(info);
    ...
    private void bindItems(AdvancedLauncher.DesktopBinder binder,
    ...
    private void bindAppWidgets(AdvancedLauncher.DesktopBinder binder,
    ...
    public void onClick(View v) {
        ...
        if (tag instanceof ApplicationInfo) {
        	...
        	if(info.isSubMenu)
        	{
        		AdvancedLauncher.getModel().openSubMenu(""+info.title);
        	}
        	else
        	{
	            // Open shortcut
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.irrenhaus.advancedlauncher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
    ...
    private class RenameFolder {
        ...
        Dialog createDialog() {
            mWaitingForResult = true;
            final View layout = View.inflate(AdvancedLauncher.this, R.layout.rename_folder, null);
        ...
        private void changeFolderName() {
            ...
            if (!TextUtils.isEmpty(name)) {
                ...
                LauncherModel.updateItemInDatabase(AdvancedLauncher.this, mFolderInfo);

                if (mDesktopLocked) {
                    mDrawer.lock();
                    sModel.loadUserItems(false, AdvancedLauncher.this, false, false);
                } else {
    ...
    private class CreateShortcut implements DialogInterface.OnClickListener,
        ...
        Dialog createDialog() {
            ...
            mAdapter = new AddAdapter(AdvancedLauncher.this);
            
            final AlertDialog.Builder builder = new AlertDialog.Builder(AdvancedLauncher.this);
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which) {
                case AddAdapter.ITEM_SHORTCUT: {
                    ...
                    shortcutIcons.add(ShortcutIconResource.fromContext(AdvancedLauncher.this,
                ...
                case AddAdapter.ITEM_APPWIDGET: {
                    int appWidgetId = AdvancedLauncher.this.mAppWidgetHost.allocateAppWidgetId();
            ...
            if (!Intent.ACTION_PACKAGE_CHANGED.equals(action)) {
                if (Intent.ACTION_PACKAGE_REMOVED.equals(action)) {
                    if (!replacing) {
                        ...
                        sModel.removePackage(AdvancedLauncher.this, packageName);
                    }
                    ...
                    if (!replacing) {
                        ...
                        sModel.addPackage(AdvancedLauncher.this, packageName);
                    } else {
                        if (LauncherModel.DEBUG_LOADERS) {
                            d(LauncherModel.LOG_TAG, "  --> update package " + packageName);
                        }
                        sModel.updatePackage(AdvancedLauncher.this, packageName);
                ...
                sModel.syncPackage(AdvancedLauncher.this, packageName);
            }
        }
    }
    ...
    private static class WallpaperIntentReceiver extends BroadcastReceiver {
        ...
        private WeakReference<AdvancedLauncher> mLauncher;

        WallpaperIntentReceiver(Application application, AdvancedLauncher launcher) {
            mApplication = application;
            setLauncher(launcher);
        }

        void setLauncher(AdvancedLauncher launcher) {
            mLauncher = new WeakReference<AdvancedLauncher>(launcher);
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (mLauncher != null) {
                final AdvancedLauncher launcher = mLauncher.get();
                if (launcher != null) {
    ...
    private static class DesktopBinder extends Handler implements MessageQueue.IdleHandler {
        ...
        private final WeakReference<AdvancedLauncher> mLauncher;
        
        public volatile boolean mTerminate = false;

        DesktopBinder(AdvancedLauncher launcher, ArrayList<ItemInfo> shortcuts,
        ...
        public void handleMessage(Message msg) {
            AdvancedLauncher launcher = mLauncher.get();
