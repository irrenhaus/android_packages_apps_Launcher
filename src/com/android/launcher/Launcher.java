	...
	/* Rogro82@xda Extended : Extended settings */
		...
		.setAlphabeticShortcut('C').setOnMenuItemClickListener(new OnMenuItemClickListener() {
			public boolean onMenuItemClick(MenuItem item) {
				...
				{
					if(SubMenuSettings.createConfigBackup(Launcher.this))
						Toast.makeText(Launcher.this, "Created backup in /sdcard/Launcher/", Toast.LENGTH_SHORT).show();
					else
						Toast.makeText(Launcher.this, "Backup creation failed!", Toast.LENGTH_SHORT).show();
		...
		.setAlphabeticShortcut('R').setOnMenuItemClickListener(new OnMenuItemClickListener() {
			public boolean onMenuItemClick(MenuItem item) {
				...
				{
					if(SubMenuSettings.restoreConfigBackup(Launcher.this))
						Toast.makeText(Launcher.this, "Restored backup successfully", Toast.LENGTH_SHORT).show();
					else
						Toast.makeText(Launcher.this, "Backup restore failed!", Toast.LENGTH_SHORT).show();
